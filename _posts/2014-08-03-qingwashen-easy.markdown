---
layout: post
title: "青蛙神（easy） qingwashen"
date: 2014-08-03 20:58
comments: true
categories: 给小朋友们组的题
---
...
为了得到十娘的原谅，昆生决定到青蛙庙里供奉一个由两个素数拼接而成的正整数$x$。例如$1723$就是一个合法的方案，因为它由素数$17$和素数$23$拼接而成，但$137$就不是，即使它本身就是一个素数。拆分出的两个数可以有前导零，如$17023$，可以拆分为$17$和$023$，也是一个合法方案。

统计在给定的$l$到$r$中$x$的数量。

##输入
第$1$行两个整数$l,r$，意义同上文描述。
...
对于$60\%$的数据，$1 \leq l\leq r \leq 1000。$<br />
对于$100\%$的数据，$1 \leq l\leq r \leq 1000000。$
